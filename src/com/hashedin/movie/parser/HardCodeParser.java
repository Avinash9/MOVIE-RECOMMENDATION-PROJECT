...
public  MovieDatabase getMovieDatabase() {
    ...
    private Map<Integer,Movie>movieFileParser()
    {
	    ...
	    movieMap.put(10, new Movie(10,"KMPS","11-01-2011","13-02-2011","http://imdb/kmps",genre));
	    genre.clear();
	    genre.add(Genre.COMEDY);
	    genre.add(Genre.ACTION);
	    movieMap.put(101, new Movie(21,"DDLJ","10-01-1998","12-01-1998","http://imdb/ddlj",genre));
	    return movieMap;
